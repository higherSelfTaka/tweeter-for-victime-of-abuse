        ...
        <div className={`flex ${!postPage && "justify-between"}`}>
            ...
            <div className="text-[#6e767d]">
                <div className="inline-block group">
                   ...
                   <h4 className={`font-bold text-[14px] sm:text-base 
                ...
                {!postPage && <p className="text-[#d9d9d9] text-[14px] sm:text-base mt-0.5">{post?.text}</p>}
            </div>

            <div className="icon group flex-shrink-0 ml-auto">
             <BookmarkIcon className="h-4 text-[#6e767d]"/> 
            </div>
        </div>
        {postPage && (
            <p className="text-[#d9d9d9] text-[14px] sm:text-base mt-0.5">{post?.text}</p>
        )}
        ...
        <div
          ...
          >
            <div className="icon group-hover:bg-[#1d9bf0] group-hover:bg-opacity-10">
              <UserIcon className="h-5 group-hover:text-[#1d9bf0]" /> 
            </div>
            {comments.length > 0 && (
