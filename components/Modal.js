            ...
            sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
             ...
             <div class="flex px-4 pt-5 pb-2.5 sm:px-6">
                  <div className="w-full">
                    <div class="text-[#6e767d] flex gap-x-3 relative">
                       {/* vertical bar span */}
                       ...
                       <div>
                        <div className="inline-block group">
                           ...
                           <span className="ml-1.5 text-sm sm:text-[15px]">
                            ...
                            ・{" "}
                            <span className="hover:underline text-sm sm:text-[14px]">
                                <Moment fromNow>{post?.timestamp?.toDate()}</Moment>
                            </span>
                            <p className="text-[#d9d9d9] text-[12px] sm:text-base mt-4">
                                {post?.text}
                            </p>
                       </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-2.5">
                        <div className="flex items-center">
                          ...
                          <div className="icon rotate-90">
                            <ChartBarSquareIcon className="text-[#1d9bf0] h-[22px]" />
                          </div>
