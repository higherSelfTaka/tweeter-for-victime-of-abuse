  ...
  return (
    <div　className="hidden lg:inline ml-8 xl:w-[450px] py-1 space-y-5">
      ...
      z-50 w-11/12 xl:w-9/12">
       ...
       <ChevronDoubleRightIcon className="text-[#a4344e] h-5 z-50" /> 
      ...
      <div className="text-[#a4344e] space-y-3 bg-[#15161c] pt-2 rounded-xl w-11/12 xl:w-9/12">
       ...
       ease-out flex items-center justify-between w-full text-[#a4344e]
